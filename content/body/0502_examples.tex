...
\index{Testing!Exploratory Testing}
...
The code for this test is included in \appref{APP:TRIANGLE}.
...
The code for this test is included in \appref{APP:MESHES}.
...
The code for this test is included in \appref{APP:TERRAIN}.
